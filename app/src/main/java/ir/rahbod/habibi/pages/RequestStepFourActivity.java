...
public class RequestStepFourActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (SessionManager.getExtrasPref(this).getString(PutKey.SERVICE_TIME).equals("am"))
            ...
            txtTime.setText("بعدازظهر (ساعت 12 الی 16)");
        else
            txtTime.setText("شب (ساعت 16 الی 20)");
